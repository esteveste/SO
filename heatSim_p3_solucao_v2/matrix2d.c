...
void
dm2dFree (DoubleMatrix2D * matrix)
{
  free (matrix->data);
  free (matrix);
}
...
double *
dm2dGetLine (DoubleMatrix2D * matrix, int line_nb)
{
...
void
dm2dSetLine (DoubleMatrix2D * matrix, int line_nb, double *line_values)
{
  memcpy ((char *) &(matrix->data[line_nb * matrix->n_c]), line_values,
	  matrix->n_c * sizeof (double));
}
...
void
dm2dSetLineTo (DoubleMatrix2D * matrix, int line, double value)
{
  int i;
...
void
dm2dSetColumnTo (DoubleMatrix2D * matrix, int column, double value)
{
  int i;
...
void
dm2dCopy (DoubleMatrix2D * to, DoubleMatrix2D * from)
{
...
void
dm2dPrint (DoubleMatrix2D * matrix)
{
  int i, j;
